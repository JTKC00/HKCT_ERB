...
# Don't deploy and show to others
...
ROOT_URLCONF = 'bcre.urls' #(folder name).(attribute)

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'templates')], #register templates
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
#if website need real time, wsgi need to change to asgi 
...
MESSAGE_TAGS = {
    messages.ERROR: "danger",  # Use 'danger' for error messages
    messages.SUCCESS: "success",  # Use 'success' for success messages
}